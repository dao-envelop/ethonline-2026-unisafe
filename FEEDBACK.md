> Copy for convenience. The canonical file lives in the contracts repo —
> [dao-envelop/uni-smart-wallet/FEEDBACK.md](https://github.com/dao-envelop/uni-smart-wallet/blob/master/FEEDBACK.md)
> — and that is the link the Uniswap Developer Feedback Form points at. The two are kept identical.
